...
void playRandomLevel() {
    ...
    Object coin_0 = newObject(getIntRandom(400, AREA-20), getIntRandom(330, 360), 25, 25, true, true, coinSprite);
    Object coin_1 = newObject(getIntRandom(400, AREA-20), getIntRandom(330, 360), 25, 25, true, true, coinSprite);
    Object coin_2 = newObject(getIntRandom(400, AREA-20), getIntRandom(330, 360), 25, 25, true, true, coinSprite);
    Object coin_3 = newObject(getIntRandom(400, AREA-20), getIntRandom(330, 360), 25, 25, true, true, coinSprite);
    Object coin_4 = newObject(getIntRandom(400, AREA-20), getIntRandom(330, 360), 25, 25, true, true, coinSprite);
    Object coin_5 = newObject(getIntRandom(400, AREA-20), getIntRandom(330, 360), 25, 25, true, true, coinSprite);
    Object coin_6 = newObject(getIntRandom(400, AREA-20), getIntRandom(330, 360), 25, 25, true, true, coinSprite);
    //Objects list
    ...
    Enemy goomba_0 = newEnemy(getIntRandom(400, AREA-20), 399, 40, 40, getIntRandom(100, 200), false, false, goombaSprite);
    Enemy goomba_1 = newEnemy(getIntRandom(1500, AREA-20), 399, 40, 40, getIntRandom(100, 200), false, false, goombaSprite);
    Enemy goomba_2 = newEnemy(getIntRandom(2500, AREA-20), 399, 40, 40, getIntRandom(100, 200), false, false, goombaSprite);
    Imagen kappaSprite = Pantalla_ImagenLee("assets/emy/kappa.bmp", 1);
    Enemy kappa_0 = newEnemy(getIntRandom(20, AREA-20), getIntRandom(330, 360), 40, 55, getIntRandom(20, AREA-20), false, true, kappaSprite);
    //Enemy list
    ...
    while (Pantalla_Activa() && isPlaying){
        ...
        if (Pantalla_TeclaPulsada(SDL_SCANCODE_X)){
            if (!isKeyPressing) {
                Shoot shoot = newShoot(getCharacterX(player), getCharacterY(player), 10, 10, 500, isCharacterInv(player), shootSprite);
